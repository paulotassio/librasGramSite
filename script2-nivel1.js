...
function drop(ev) {
    ...
    if (target.classList.contains('target')) {
        if (target.dataset.fase.trim() != null) {
            ...
            var requiredWords = ["amanhã", "encontrar", "amigo", "meu"];
...
function voltar() {
    ...
    window.location.href = "jogo1n1.html?pontuacao=" + pontuacao2;
}
...
function avancar() {
    /*alert("PARABÉNS!");*/
    window.location.href = "nivel3n1.html?pontuacao=" + pontuacao2;
}
